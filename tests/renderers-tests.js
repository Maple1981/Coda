...
assert.ok(progressionWorkbenchHtml.indexOf('id="progressionGenerateMelodicVoice" type="checkbox"') > -1);
assert.equal(progressionWorkbenchHtml.indexOf('id="progressionGenerateMelodicVoice" type="checkbox" checked'), -1);
assert.ok(progressionWorkbenchHtml.indexOf('data-i18n="progression.generateMelodicVoice"') > -1);
