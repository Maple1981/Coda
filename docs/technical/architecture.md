...
- La lógica de secciones debe mantenerse separada por responsabilidad: documento de secciones, retarget tonal, variaciones, candidatos tonales, modulación y orquestación. Evitar que `progression-section-contrast-service.js` vuelva a acumular clonación, reindexado, variación, búsqueda tonal y reglas modulantes en un único archivo.
