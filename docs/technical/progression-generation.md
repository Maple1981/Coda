...
La parsimonia se evalúa por voz, no sólo por distancia total del acorde. Los movimientos por semitono, tono o tercera deben prevalecer siempre que el acorde lo permita; las cuartas, quintas y saltos mayores reciben una penalización creciente, con especial cuidado en la voz superior. Si dos candidatos tienen un coste global parecido, se prefiere el que reparte movimientos pequeños entre las voces antes que el que deja varias voces quietas y concentra un salto amplio en soprano o en una voz interior. Las disposiciones abiertas pueden separar el registro, pero no deben aislar una voz superior a una distancia exagerada si eso rompe la identidad melódica de las líneas.
