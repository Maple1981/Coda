...
- `js/renderers/`: modulos de renderizado. `scale-chords-renderer.js` genera la tabla de acordes diatonicos y `extended-harmony-renderer.js` genera las tablas de armonia extendida desde datos de escala/acordes y delega el calculo musical en dominio.
